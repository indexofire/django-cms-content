...
from cms_content.views import sections, section_view, categories, category_view, article_view
...
urlpatterns = patterns ('',
    ...
    url(r'^(?P<slug>.*)/$', category_view, name='category_view'),
    url(r'^(?P<slug>.*/<path>.*)/$', article_view),
