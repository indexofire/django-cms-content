    ...
    def get_nodes(self, request):
        ...
        for section in sections:
            ...
            for category in categories:
                url = settings.ROOT_URL + section.get_absolute_url() + category.get_absolute_url()
                parent = count
                ...
                for article in articles:
                    url = settings.ROOT_URL + section.get_absolute_url() + category.get_absolute_url() + article.get_absolute_url()
