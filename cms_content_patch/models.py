...
class BaseContentModel(models.Model):
    """
    Base Content Class For All Levels Model.
    """
    ...
    intro_img_width = models.PositiveIntegerField(
        blank       = True,
        default     = 480
    )
    intro_img_height = models.PositiveIntegerField(
        blank       = True,
        default     = 160
    )
    ...
    def get_object_url(self):
        return ("%(app_label)s_%(class)s_detail", (self.slug,))
    
    @models.permalink
    def get_list_objects_url(self):
        return ("%(app_label)s_%(class)s_list")
        

class Section(BaseContentModel):
    """
    Section Model
    """
...
class Category(BaseContentModel):
    ...
    child  = models.ForeignKey('Article')
    pass
